...
public class MyZookeeperMainDeleteQuotaTest  extends ClientBase{
    ...
    public MyZookeeperMainDeleteQuotaTest(boolean expectedRes, boolean zk, String path, long bytes, int numNodes){
